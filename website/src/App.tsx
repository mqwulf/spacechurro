  ...
  return <>
    ...
    <nav className="navbar bg-dark">
      <div className="container-fluid">
        <a className="navbar-brand nav-font text-white" href="#">spacechurro</a>
      </div>
    </nav>
    <div className="left-container mb-3">
      ...
      <div className="mt-1 input-group">
        ...
        <input type="text" className="form-control bg-secondary text-white input-area" placeholder="Enter Celestial Body" />
        <button className="btn bg-body-secondary" type="button">
